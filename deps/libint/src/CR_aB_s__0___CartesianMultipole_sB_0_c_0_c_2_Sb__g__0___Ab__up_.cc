...
fp5 = 0 + src2[((hsi*7+5)*1+lsi)*1];
LIBINT2_REALTYPE fp10;
fp10 = 0 + src2[((hsi*7+4)*1+lsi)*1];
...
fp0 = 0 + src2[((hsi*7+6)*1+lsi)*1];
LIBINT2_REALTYPE fp1;
fp1 = fp0 + fp2;
LIBINT2_REALTYPE fp3;
fp3 = fp1 + fp4;
LIBINT2_REALTYPE fp33;
fp33 = 0 + src1[((hsi*7+0)*1+lsi)*1];
LIBINT2_REALTYPE fp34;
fp34 = 0 + src0[((hsi*7+0)*1+lsi)*1];
