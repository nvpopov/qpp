...
fp91 = 1 * inteval->oo2z[vi];
LIBINT2_REALTYPE fp90;
fp90 = fp91 * target[((hsi*24+4)*1+lsi)*1];
LIBINT2_REALTYPE fp94;
fp94 = 1 * inteval->oo2z[vi];
