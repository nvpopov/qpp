...
fp52 = 0 + src0[((hsi*20+4)*1+lsi)*1];
LIBINT2_REALTYPE fp54;
fp54 = inteval->BO_x[vi] * fp52;
LIBINT2_REALTYPE fp53;
fp53 = fp55 + fp54;
LIBINT2_REALTYPE fp38;
fp38 = 0 + src1[((hsi*20+12)*1+lsi)*1];
...
fp44 = 0 + src1[((hsi*20+0)*1+lsi)*1];
LIBINT2_REALTYPE fp62;
fp62 = 0 + src0[((hsi*20+9)*1+lsi)*1];
LIBINT2_REALTYPE fp59;
fp59 = 0 + src0[((hsi*20+8)*1+lsi)*1];
...
fp76 = 0 + src0[((hsi*20+17)*1+lsi)*1];
LIBINT2_REALTYPE fp79;
fp79 = inteval->BO_x[vi] * fp76;
LIBINT2_REALTYPE fp77;
fp77 = 0 + src0[((hsi*20+18)*1+lsi)*1];
...
fp69 = 0 + src0[((hsi*20+13)*1+lsi)*1];
LIBINT2_REALTYPE fp66;
fp66 = 0 + src0[((hsi*20+12)*1+lsi)*1];
...
fp48 = 0 + src0[((hsi*20+1)*1+lsi)*1];
LIBINT2_REALTYPE fp45;
fp45 = 0 + src0[((hsi*20+0)*1+lsi)*1];
