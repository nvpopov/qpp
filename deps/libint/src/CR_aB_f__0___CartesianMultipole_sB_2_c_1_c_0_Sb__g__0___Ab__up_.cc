...
fp39 = 0 + src1[((hsi*32+20)*1+lsi)*1];
LIBINT2_REALTYPE fp38;
fp38 = inteval->BO_y[vi] * fp39;
LIBINT2_REALTYPE fp36;
fp36 = 0 + src1[((hsi*32+21)*1+lsi)*1];
...
fp49 = 0 + src1[((hsi*32+17)*1+lsi)*1];
LIBINT2_REALTYPE fp48;
fp48 = 0 + src1[((hsi*32+16)*1+lsi)*1];
...
fp81 = 0 + src1[((hsi*32+1)*1+lsi)*1];
LIBINT2_REALTYPE fp80;
fp80 = 0 + src1[((hsi*32+0)*1+lsi)*1];
...
fp65 = 0 + src1[((hsi*32+9)*1+lsi)*1];
LIBINT2_REALTYPE fp64;
fp64 = 0 + src1[((hsi*32+8)*1+lsi)*1];
...
fp26 = 0 + src1[((hsi*32+27)*1+lsi)*1];
LIBINT2_REALTYPE fp29;
fp29 = 0 + src1[((hsi*32+26)*1+lsi)*1];
...
fp33 = 0 + src1[((hsi*32+25)*1+lsi)*1];
LIBINT2_REALTYPE fp32;
fp32 = 0 + src1[((hsi*32+24)*1+lsi)*1];
