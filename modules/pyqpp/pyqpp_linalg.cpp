...
template<class VALTYPE>
void py_matrix3d_export(const char * pyname, py::module m){
  py::class_<qpp::matrix3d<VALTYPE> >(m, pyname)
      .def(py::init<>())
      .def(py::init<const qpp::matrix3d<VALTYPE>&>())
      .def(py::init<VALTYPE,VALTYPE,VALTYPE,VALTYPE,VALTYPE,VALTYPE,VALTYPE,VALTYPE,VALTYPE>())
      .def(py::init<VALTYPE>())
      .def(py::init<const qpp::vector3d<VALTYPE>&, const qpp::vector3d<VALTYPE>&, const qpp::vector3d<VALTYPE>&>())
      .def(py::init<const py::list&>())
      .def(py::init<const py::tuple&>())
      ...
      .def_property("xx",  & qpp::matrix3d<VALTYPE>::py_getxx, & qpp::matrix3d<VALTYPE>::py_setxx)
      .def_property("xy",  & qpp::matrix3d<VALTYPE>::py_getxy, & qpp::matrix3d<VALTYPE>::py_setxy)
      .def_property("xz",  & qpp::matrix3d<VALTYPE>::py_getxz, & qpp::matrix3d<VALTYPE>::py_setxz)
      .def_property("yx",  & qpp::matrix3d<VALTYPE>::py_getyx, & qpp::matrix3d<VALTYPE>::py_setyx)
      .def_property("yy",  & qpp::matrix3d<VALTYPE>::py_getyy, & qpp::matrix3d<VALTYPE>::py_setyy)
      .def_property("yz",  & qpp::matrix3d<VALTYPE>::py_getyz, & qpp::matrix3d<VALTYPE>::py_setyz)
      .def_property("zx",  & qpp::matrix3d<VALTYPE>::py_getzx, & qpp::matrix3d<VALTYPE>::py_setzx)
      .def_property("zy",  & qpp::matrix3d<VALTYPE>::py_getzy, & qpp::matrix3d<VALTYPE>::py_setzy)
      .def_property("zz",  & qpp::matrix3d<VALTYPE>::py_getzz, & qpp::matrix3d<VALTYPE>::py_setzz)
...
void py_rotrans_export(const char * pyname, py::module m){
  if (BOUND)
    py::class_<qpp::rotrans<REAL,BOUND> >(m, pyname)
        ...
        .def(py::init<const qpp::vector3d<REAL>, const qpp::matrix3d<REAL>, qpp::periodic_cell<REAL>* >())
        ...
        .def_readwrite_static("tol_trans",& qpp::rotrans<REAL,BOUND>::translation_tolerance)
        .def_readwrite_static("tol_rot",& qpp::rotrans<REAL,BOUND>::rotation_tolerance)
...
void pyqpp_linalg_export(py::module m){
  ...
  py_matrix3d_export<float>("matrix3f", m);
  py_matrix3d_export<double>("matrix3d", m);
  py_matrix3d_export<std::complex<float> >("matrix3c", m);
  py_matrix3d_export<std::complex<double> >("matrix3z", m);
  ...
  py_rotrans_export<float,false>("rotrans_f", m);
  py_rotrans_export<double,false>("rotrans_d", m);
  py_rotrans_export<float,true>("bound_rotrans_f", m);
  py_rotrans_export<double,true>("bound_rotrans_d", m);


  qpp::index::py_export("index", m);
  qpp::iterator::py_export("iterator", m);
  qpp::index_range::py_export("index_range", m);
}
