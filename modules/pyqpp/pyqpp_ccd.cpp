...
void pyqpp_ccd_export(py::module m) {
  ...
  py::enum_<comp_chem_program_e>(m, "comp_chem_program_e", py::arithmetic(), "")
      .value("pr_unknown", comp_chem_program_e::pr_unknown, "pr_unknown")
      .value("pr_vasp", comp_chem_program_e::pr_vasp, "pr_vasp")
      .value("pr_firefly", comp_chem_program_e::pr_firefly, "pr_firefly")
      .value("pr_pc_gamess", comp_chem_program_e::pr_pc_gamess, "pr_pc_gamess")
      .value("pr_cp2k", comp_chem_program_e::pr_cp2k, "pr_cp2k")
      .value("pr_orca", comp_chem_program_e::pr_orca, "pr_orca")
      .value("pr_molcas", comp_chem_program_e::pr_molcas, "pr_molcas")
      .value("pr_molden", comp_chem_program_e::pr_molden, "pr_molden")
      .export_values();

  py::enum_<comp_chem_program_run_e>(m, "comp_chem_program_run_e", py::arithmetic(), "")
      .value("rt_unknown", comp_chem_program_run_e::rt_unknown, "rt_unknown")
      .value("rt_energy", comp_chem_program_run_e::rt_energy, "rt_energy")
      .value("rt_grad", comp_chem_program_run_e::rt_grad, "rt_grad")
      .value("rt_geo_opt", comp_chem_program_run_e::rt_geo_opt, "rt_geo_opt")
      .value("rt_cell_opt", comp_chem_program_run_e::rt_cell_opt, "rt_cell_opt")
      .value("rt_md", comp_chem_program_run_e::rt_md, "rt_md")
      .value("rt_vib", comp_chem_program_run_e::rt_vib, "rt_vib")
      .value("rt_raman", comp_chem_program_run_e::rt_raman, "rt_raman")
      .value("rt_tddft", comp_chem_program_run_e::rt_tddft, "rt_tddft")
      .value("rt_spectrum", comp_chem_program_run_e::rt_spectrum, "rt_spectrum")
      .export_values();
