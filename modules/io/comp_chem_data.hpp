...
enum class ccd_spin_e {
  spin_alpha,
  spin_beta
};

enum class comp_chem_program_run_e {
  rt_unknown,
  rt_energy,
  rt_grad,
  rt_geo_opt,
...
static std::map<comp_chem_program_e, std::string> ccdprog2str = {
    std::make_pair(comp_chem_program_e::pr_unknown, "Unknown"),
    std::make_pair(comp_chem_program_e::pr_vasp,    "VASP"),
    std::make_pair(comp_chem_program_e::pr_firefly, "PC Gamess Firefly"),
    std::make_pair(comp_chem_program_e::pr_cp2k,    "CP2K"),
    std::make_pair(comp_chem_program_e::pr_orca,    "Orca"),
    std::make_pair(comp_chem_program_e::pr_molcas,  "OpenMolcas"),
    std::make_pair(comp_chem_program_e::pr_molden,  "Molden")
};

static std::map<comp_chem_program_run_e, std::string> ccdrt2str = {
    std::make_pair(comp_chem_program_run_e::rt_unknown,  "Unknown"),
    std::make_pair(comp_chem_program_run_e::rt_energy,   "Single-point energy"),
    std::make_pair(comp_chem_program_run_e::rt_grad,     "Gradients calculation"),
    std::make_pair(comp_chem_program_run_e::rt_geo_opt,  "Geometry optimization"),
    std::make_pair(comp_chem_program_run_e::rt_cell_opt, "Cell optimization"),
    std::make_pair(comp_chem_program_run_e::rt_md,       "Molecular dynamics"),
    std::make_pair(comp_chem_program_run_e::rt_vib,      "Vibrations calculation"),
    std::make_pair(comp_chem_program_run_e::rt_raman,    "Raman spectrum calculation"),
    std::make_pair(comp_chem_program_run_e::rt_tddft,    "TDDFT energy calculation"),
    std::make_pair(comp_chem_program_run_e::rt_spectrum, "Generic spectrum calculation")
};
