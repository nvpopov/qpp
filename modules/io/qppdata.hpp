...
#define STRING std::string
  ...
  enum{
    data_parameter     = 0x0002000,
    data_declaration   = 0x0004000,
    data_geometry      = 0x0008000,
    data_xgeometry     = 0x0010000,
    data_vectors       = 0x0020000,
    data_basis         = 0x0040000,
    data_manyfold      = 0x0080000,
    data_zmatrix       = 0x0100000,
    data_zpattern      = 0x0200000,
    data_zpt_bond      = 0x0400000,
    data_zpt_angle     = 0x0800000,
    data_zpt_dihedral  = 0x1000000,
    data_zpt_surfangle = 0x2000000,
    data_geom_modifier = 0x4000000,
    data_region        = 0x8000000,
    ...
    data_dim2         = 0x0004,
    data_dim3         = 0x0008,
    data_type_int     = 0x0010,
    data_type_bool    = 0x0020,
    data_type_double  = 0x0040,
    data_type_float   = 0x0080,
    data_type_string  = 0x0100,
    data_basis_pw     = 0x0200,
    data_basis_gauss  = 0x0400,
    data_basis_slater =	0x0800,
    data_basis_siesta =	0x1000
  };
