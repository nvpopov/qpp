...
public:
  ...
  inline void set(int    _i) { i=_i; tp = basic_types::type_int;    ptr=false;}
  inline void set(float  _f) { f=_f; tp = basic_types::type_float;  ptr=false;}
  inline void set(double _d) { d=_d; tp = basic_types::type_double; ptr=false;}
  inline void set(bool   _b) { b=_b; tp = basic_types::type_bool;   ptr=false;}
  inline void set(const STRING_EX &_s){ s=_s; tp = basic_types::type_string; ptr=false; }
  inline void set(const char *_s)  { s=_s; tp = basic_types::type_string; ptr=false; }

  inline void set(int    *_i) { pi=_i; tp = basic_types::type_int;    ptr=true;}
  inline void set(float  *_f) { pf=_f; tp = basic_types::type_float;  ptr=true;}
  inline void set(double *_d) { pd=_d; tp = basic_types::type_double; ptr=true;}
  inline void set(bool   *_b) { pb=_b; tp = basic_types::type_bool;   ptr=true;}
  inline void set(STRING_EX *_s) { ps=_s; tp = basic_types::type_string; ptr=true;}
...
operator<<(std::basic_ostream<_CharT, _Traits>& __os, const datum &v) {
  ...
  switch (v.type()) {
   case basic_types::type_bool:   __s << (v.get<bool>() ? "true" : "false"); break;
   case basic_types::type_int:    __s << v.get<int>(); break;
   case basic_types::type_float:  __s << v.get<float>(); break;
   case basic_types::type_double: __s << v.get<double>(); break;
   case basic_types::type_string: __s << v.get<STRING_EX>(); break;
   default: break;
  }
