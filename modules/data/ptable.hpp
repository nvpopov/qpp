...
namespace qpp {
    ...
    public:
        ...
        static optional<float> mass_by_number (const uint number) {
        ...
        static optional<float> ionic_rad_by_number (const uint number) {
        ...
        static optional<float> vdw_rad_by_number (const uint number) {
