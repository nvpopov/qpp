...
public:
  ...
  py::list py_getalln(int l){return py::list(py::cast(nullptr));}
  ...
  py::list py_getallcoeff(int l){return py::list(py::cast(nullptr));}
  ...
  py::list py_getallalpha(int l) {return py::list(py::cast(nullptr));}
