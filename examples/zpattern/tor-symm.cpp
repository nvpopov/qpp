...
{
  v2d p0(pi/10,pi/2);
  v2d p1 = mfold->ruler(p0,v2d(1,0),rcc);  
  v2d p2 = mfold->protract(p0,p1,rcc, 2*qpp::pi/3);
  v2d p3 = mfold->protract(p0,p1,rcc,-2*qpp::pi/3);
...
int main(int argc, char* argv[])
{
  ...
  symm(1) = Sigma(lace::vector3d<double>(1,0,0));
