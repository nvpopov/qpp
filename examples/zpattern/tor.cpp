...
int main()
{
  ...
  p.push_back(sph.triangul(p[0],p[1],rcc,2*qpp::pi/3));
  ...
  z1[0].add_relation(* new zpt::bond_relation("CX","C4", 0, rcc, z1[0]));
  // -----------------------------------------------------------------
  ...
  z1[1].add_relation(* new zpt::dyhedral_relation("C1","C2","C3","C4",-45,45,z1[1]));
  z1[1].add_relation(* new zpt::bond_relation("CX","C4", 0, rcc, z1[1]));
  // ----------------------------------------------------------------- 
  std::cout << "trng\n";
  ...
  z2[1].add_relation(* new zpt::angle_relation("C1","C2","C3", 110, 124,  z2[1]));
  z2[1].add_relation(* new zpt::angle_relation("C2","C3","C4", 110, 124,  z2[1]));
  ...
  z2[2].add_point(zpt::zpt_point("C2","C"),zpt::zsearch);
  z2[2].add_point(zpt::zpt_point("C3","C"),zpt::zsearch);
  z2[2].add_point(zpt::zpt_point("C4","C"),zpt::zsearch);
  z2[2].add_point(zpt::zpt_point("C5","C"),zpt::zsearch);
  z2[2].add_point(zpt::zpt_point("C6","C"),zpt::zinsert);
  z2[2].add_point(zpt::zpt_point("C7","C"),zpt::zinsert);
  z2[2].add_point(zpt::zpt_point("CX1","C"),zpt::zavoid);
  z2[2].add_point(zpt::zpt_point("CX2","C"),zpt::zavoid);
  
  z2[2].add_relation(* new zpt::bond_relation("C1","C2", rcc_min, rcc_max, z2[2]));
  z2[2].add_relation(* new zpt::bond_relation("C2","C3", rcc_min, rcc_max, z2[2]));
  z2[2].add_relation(* new zpt::bond_relation("C3","C4", rcc_min, rcc_max, z2[2]));
  z2[2].add_relation(* new zpt::bond_relation("C4","C5", rcc_min, rcc_max, z2[2]));
  z2[2].add_relation(* new zpt::angle_relation("C1","C2","C3", 110, amax,  z2[2]));
  z2[2].add_relation(* new zpt::angle_relation("C2","C3","C4", 124, amax,  z2[2]));
  z2[2].add_relation(* new zpt::angle_relation("C3","C4","C5", 124, amax,  z2[2]));
  z2[2].add_relation(* new zpt::bond_relation("C5","C6", *new zpt::linear_dependence(rcc,z2[2]), z2[2]));
  z2[2].add_relation(* new zpt::angle_relation("C4","C5","C6", 
					       *new zpt::linear_dependence(128.57,z2[2]), z2[2]));
  z2[2].add_relation(* new zpt::bond_relation("C6","C7", *new zpt::linear_dependence(rcc,z2[2]), z2[2]));
  z2[2].add_relation(* new zpt::bond_relation("C1","C7", *new zpt::linear_dependence(rcc,z2[2]), z2[2]));
  z2[2].add_relation(* new zpt::angle_relation("C5","C6","C7", amin, amax, z2[2]));
  z2[2].add_relation(* new zpt::angle_relation("C6","C7","C1", amin, amax, z2[2]));
  z2[2].add_relation(* new zpt::angle_relation("C7","C1","C2", amin, amax, z2[2]));
  
  z2[2].add_relation(* new zpt::bond_relation("CX1","C6", 0, rcc_min, z2[2]));
  z2[2].add_relation(* new zpt::bond_relation("CX2","C7", 0, rcc_min, z2[2]));
  //----------------------------------------------------------------------------
  // -----------------------------------------------------------------
  z2[3].add_point(zpt::zpt_point("C1","C"),zpt::zsearch);
  z2[3].add_point(zpt::zpt_point("C2","C"),zpt::zsearch);
  z2[3].add_point(zpt::zpt_point("C3","C"),zpt::zsearch);
  z2[3].add_point(zpt::zpt_point("C4","C"),zpt::zsearch);
  z2[3].add_point(zpt::zpt_point("C5","C"),zpt::zinsert);
  z2[3].add_point(zpt::zpt_point("CX","C"),zpt::zavoid);
  
  z2[3].add_relation(* new zpt::bond_relation("C1","C2", rcc_min, rcc_max, z2[3]));
  z2[3].add_relation(* new zpt::bond_relation("C2","C3", rcc_min, rcc_max, z2[3]));
  z2[3].add_relation(* new zpt::bond_relation("C3","C4", rcc_min, rcc_max, z2[3]));
  z2[3].add_relation(* new zpt::angle_relation("C1","C2","C3", 120, amax,  z2[3]));
  z2[3].add_relation(* new zpt::angle_relation("C2","C3","C4", 124, amax,  z2[3]));
  z2[3].add_relation(* new zpt::bond_relation("C4","C5", *new zpt::linear_dependence(rcc,z2[3]), z2[3]));
  z2[3].add_relation(* new zpt::angle_relation("C3","C4","C5", 
					       *new zpt::linear_dependence(128.57,z2[3]), z2[3]));
  z2[3].add_relation(* new zpt::dyhedral_relation("C2","C3","C4","C5",-45,45,z2[3]));
  z2[3].add_relation(* new zpt::bond_relation("CX","C5", 0, rcc_min, z2[3]));
  // -----------------------------------------------------------------------------------------
