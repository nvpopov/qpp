...
int main(){
  ...
  float cube_val_0_0_0 = qpp::get_field_value_at(0,0,0, cube_header.steps[0], cube_header.steps[1],
      field);
  float cube_val_0_0_6 = qpp::get_field_value_at(0,0,6, cube_header.steps[0], cube_header.steps[1],
      field);
  float cube_val_0_0_11 = qpp::get_field_value_at(0,0,11, cube_header.steps[0], cube_header.steps[1],
      field);
