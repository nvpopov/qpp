...
int main(){
  ...
  qpp::scalar_volume_t<float> vol;

  qpp::read_cube(cube1, g1, vol);
  ...
  float cube_val_0_0_0  = qpp::get_field_value_at(0,0,0, vol);
  float cube_val_0_0_6  = qpp::get_field_value_at(0,0,6, vol);
  float cube_val_0_0_11 = qpp::get_field_value_at(0,0,11, vol);
